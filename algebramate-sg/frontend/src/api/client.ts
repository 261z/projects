...
export const api = {
  ...
  startPractice: (topic: string, skill_id?: string, difficulty = 2) => request<{ question: Question; retrieval: string }>("/practice/start", { method: "POST", body: JSON.stringify({ topic, skill_id, difficulty }) }),
